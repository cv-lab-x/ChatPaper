...
def get_objpixmap(pdf, obj, zoom=4, savepath=None, get_tmpfile_dir=True):
    ...
    if get_tmpfile_dir:
        ...
        tmp_path = os.path.join("./test", str(page_id) + "_" + str(figType) + "_" + str(name_id) +'.png')
...
def save_objpixmap(pdf, obj, zoom=4, savepath=None):
    """
    save pixmap(tmp_path) of the object
    ...
    img_name = str(figType) + "_" + str(name_id) +'.png'
